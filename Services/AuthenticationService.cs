...
namespace Hotel_Frontend.Services
{
    ...
    public interface IAuthenticationService
    {
        ...
        Task Logout();
        Task<LoginModel> RegisterModel(Model model);
    }
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<LoginModel> RegisterModel(Model model)
        {
            ...
            var loginModel = new LoginModel(data.Username, data.Password);
            return loginModel;
        }
    }
}